...
import {HabilidadesService} from "../../../armado-uno/components/habilidades/service/habilidades.service";
...
export class TecnicaComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.habilidadesHereo = this.habilidadesService.habilidadesHereo
  }
