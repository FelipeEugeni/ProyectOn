...
@Component({
  selector: 'app-inventario-selec',
  templateUrl: './inventario-selec.component.html',
  styleUrls: ['./inventario-selec.component.css']
})
export class InventarioSelecComponent implements OnInit {
