...
export class ArmadoUnoComponent implements OnInit {
  public nivelId: Niveles = {exp: 0, nivel: 0}
  public experienciaPorNivel: Niveles[] = [
    {nivel: 0, exp: 0},
    {nivel: 1, exp: 200},
    {nivel: 2, exp: 300},
    {nivel: 3, exp: 425},
  ...
  ngOnInit(): void {
    this.nivel = this.experienciaPorNivel
  }

  public experiencia(id: number) {
